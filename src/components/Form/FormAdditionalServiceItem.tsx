...
export interface FormAdditionalServiceItemProps {
  id: string;
  icon: LucideIcon;
  title: string;
  description: string;
...
export const FormAdditionalServiceItem = React.forwardRef<
  HTMLLabelElement,
  FormAdditionalServiceItemProps
>(
  (
    {
      id,
    ...
    return (
      <label
        ref={ref}
        htmlFor={id}
        className={cn("flex items-center gap-4 py-3 cursor-pointer group", className)}
      >
...
FormAdditionalServiceItem.displayName = "FormAdditionalServiceItem";
