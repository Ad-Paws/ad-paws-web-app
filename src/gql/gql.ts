...
const documents: Documents = {
    ...
    "\n  query DashboardAgenda($date: DateTime!) {\n    reservationsOn(date: $date) {\n      id\n      scheduledCheckIn\n      scheduledCheckOut\n      actualCheckInAt\n      status\n      paymentStatus\n      total\n      dog {\n        id\n        name\n        breed\n        imageUrl\n        primaryOwner {\n          id\n          name\n          lastname\n        }\n      }\n      items {\n        kind\n        service {\n          type\n        }\n      }\n    }\n  }\n": types.DashboardAgendaDocument,
    "\n  query OverdueArrivals($before: DateTime!) {\n    reservations(filter: { status: PENDING, to: $before }, first: 30) {\n      id\n      scheduledCheckIn\n      scheduledCheckOut\n      actualCheckInAt\n      status\n      paymentStatus\n      total\n      dog {\n        id\n        name\n        breed\n        imageUrl\n        primaryOwner {\n          id\n          name\n          lastname\n        }\n      }\n      items {\n        kind\n        service {\n          type\n        }\n      }\n    }\n  }\n": types.OverdueArrivalsDocument,
    "\n  query PendingPayments {\n    pendingPayments {\n      amount\n      reservations\n      dog {\n        id\n        name\n        imageUrl\n      }\n    }\n  }\n": types.PendingPaymentsDocument,
    "\n  query DogUnpaidReservations($dogId: ID!) {\n    reservations(filter: { dogId: $dogId }, first: 30) {\n      id\n      scheduledCheckIn\n      scheduledCheckOut\n      status\n      paymentStatus\n      total\n      items {\n        kind\n        name\n      }\n    }\n  }\n": types.DogUnpaidReservationsDocument,
    "\n  query Dogs($search: String, $first: Int) {\n    dogs(search: $search, first: $first) {\n      id\n      name\n      breed\n      color\n      birthDate\n      gender\n      imageUrl\n      size\n      weightKg\n      companyProfile {\n        firstVisitAt\n        lastVisitAt\n      }\n      primaryOwner {\n        id\n        name\n        lastname\n        email\n        phone\n        profilePicture\n      }\n    }\n  }\n": types.DogsDocument,
    "\n  query Dog($id: ID!) {\n    dog(id: $id) {\n      id\n      name\n      breed\n      color\n      birthDate\n      gender\n      imageUrl\n      size\n      weightKg\n      notes\n      primaryOwner {\n        id\n        name\n        lastname\n        email\n        phone\n        profilePicture\n        birthDate\n        gender\n        status\n      }\n    }\n  }\n": types.DogDocument,
