        ...
        <Table>
          <TableHeader className="sticky top-0 bg-white z-10">
            <TableRow className="border-b border-gray-100 hover:bg-transparent">
              <TableHead className="text-xs text-[#6B7280] font-medium uppercase tracking-wider py-4 px-6">
                Owner Name
              </TableHead>
              <TableHead className="text-xs text-[#6B7280] font-medium uppercase tracking-wider py-4 px-4">
                Contact Info
              </TableHead>
              <TableHead className="text-xs text-[#6B7280] font-medium uppercase tracking-wider py-4 px-4">
                Pets
              ...
              <TableHead className="text-xs text-[#6B7280] font-medium uppercase tracking-wider py-4 px-4 text-center">
                Actions
              </TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {data.map((owner, index) => (
              ...
              >
                ...
                <TableCell className="py-4 px-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-[#9CA3AF]">ID: #{owner.id}</p>
                    </div>
                  </div>
                </TableCell>
                ...
                {/* Last Visit */}
                <TableCell className="py-4 px-4">
                  <span className="text-[#4B5563]">{owner.lastVisit}</span>
                </TableCell>
